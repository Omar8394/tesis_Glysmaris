...
-- Volcando estructura para tabla operaciones_dulce_tia.produccion_costos
CREATE TABLE IF NOT EXISTS `produccion_costos` (
  ...
  `valor_real` decimal(10,2) NOT NULL DEFAULT '0.00',
...
-- Volcando datos para la tabla operaciones_dulce_tia.produccion_costos: 0 rows
