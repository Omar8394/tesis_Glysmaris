...
-- Volcando estructura para tabla operaciones_dulce_tia.producto_combo_items
CREATE TABLE IF NOT EXISTS `producto_combo_items` (
  ...
  KEY `id_producto_incluido` (`id_producto_incluido`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla operaciones_dulce_tia.producto_combo_items: 0 rows
