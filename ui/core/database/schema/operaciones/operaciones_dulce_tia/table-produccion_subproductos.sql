...
-- Volcando estructura para tabla operaciones_dulce_tia.produccion_subproductos
CREATE TABLE IF NOT EXISTS `produccion_subproductos` (
  ...
  KEY `id_producto_subproducto` (`id_producto_subproducto`),
  KEY `idx_merma` (`id_merma`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla operaciones_dulce_tia.produccion_subproductos: 0 rows
