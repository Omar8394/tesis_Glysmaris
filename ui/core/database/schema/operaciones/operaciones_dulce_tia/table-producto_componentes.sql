...
-- Volcando estructura para tabla operaciones_dulce_tia.producto_componentes
CREATE TABLE IF NOT EXISTS `producto_componentes` (
  ...
  `id_producto_componente` int DEFAULT NULL,
  `cantidad_necesaria` decimal(10,4) NOT NULL,
  PRIMARY KEY (`id_componente`),
  KEY `id_producto` (`id_producto`),
  KEY `id_ingrediente` (`id_ingrediente`),
  KEY `id_producto_componente` (`id_producto_componente`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla operaciones_dulce_tia.producto_componentes: 0 rows
